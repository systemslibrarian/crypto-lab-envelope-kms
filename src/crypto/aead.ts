...
export async function aeadSeal(
  ...
  const sealed = new Uint8Array(
    await crypto.subtle.encrypt(
      { name: 'AES-GCM', iv, additionalData: aadRaw, tagLength: 128 },
      cryptoKey,
      plaintextRaw,
    ),
  );
